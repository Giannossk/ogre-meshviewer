...
curl -L https://dl.cloudsmith.io/public/ogrecave/ogre/raw/versions/v14.5.2/ogre-sdk-v14.5.2-msvc142-x64.zip -o ogre-sdk.zip
...
mv package ogre-meshviewer_26.02-win64
